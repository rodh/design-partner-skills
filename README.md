...
Skills scan the working directory for existing artifacts and build on prior work automatically. Artifacts are saved to `artifacts/` by default. To use a different directory, add `Artifact directory: <path>` to your project's CLAUDE.md.
